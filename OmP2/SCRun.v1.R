...
integrated_seurat=RenameIdents(integrated_seurat, `0` = "Progenitor I",
                                            `1` = "Stem I", 
                                            `2` = "Goblet II",
                                            `3` = "Enterocyte Imm", 
                                            `4` = "Progenitor II", 
                                            ...
                                            `7` = "TA", 
                                            `8` = "Tuft",
                                            `9` = "Enteroendocrine II", 
                                            `10` = "Paneth", 
                                            `11` = "Enterocyte M", 
                                            `12` = "Enteroendocrine I", 
                                            `13` = "Unclassified")

levels(integrated_seurat) = c("Stem I", "Stem II", "TA","Progenitor I",
                              "Progenitor II", "Enterocyte Imm", "Enterocyte M",
                              "Goblet I", "Goblet II","Paneth","Tuft", 
                              "Enteroendocrine I", "Enteroendocrine II", "Unclassified")

my_colors <- c(brewer.pal(8, "Set2"), brewer.pal(6, "Pastel1"))
# umap mixed
umap_plot_mixed = DimPlot(integrated_seurat, reduction = "umap", cols = my_colors)

ggsave("umap_plot_mixed.png", plot = wrap_plots(umap_plot_mixed), width = 8, height = 5, dpi = 300)
...
# umap split
umap_plot_split = DimPlot(integrated_seurat, reduction = "umap", cols = my_colors, split.by = "orig.ident")

ggsave("umap_plot_split.png", plot = wrap_plots(umap_plot_split), width = 11, height = 5, dpi = 300)
